  ...
  <div class="container">
    ...
    <div class="login-container">
      <div class="login-content">
        ...
        <p class="form-subtitle">We have sent a verification code to your email address</p>
        <p class="form-subtitle">Please enter the One-Time Password (OTP) <br> sent to your email to proceed.</p>
        @error('otp')
        ...
        <form method="post" action="{{ route('verify.otp') }}" class="login-form">
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              <i class="fas fa-key"></i> <!-- Font Awesome for email -->
              <input type="text" placeholder="Enter Code" name="otp"  maxlength="6" required="" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
            </div>
          </div>
