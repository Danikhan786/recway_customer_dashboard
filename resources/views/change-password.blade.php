    ...
    <div class="container">
        ...
        <div class="login-container">
            <div class="login-content">
                ...
                <h1 class="form-title">{{ __('messages.reset_password') }}</h1>
                <p class="form-subtitle">{{ __('messages.reset_password_note') }}</p>
                @if ($errors->any())
                ...
                <form method="post" action="{{ route('password.update') }}" class="login-form">
                    ...
                    <div class="form-group">
                        <div class="input-wrapper">
                            ...
                            <input type="password" id="new-password"
                                placeholder="{{ __('messages.enter_new_password') }}" name="password" required="">
                    ...
                    <button type="submit" class="login-btn">{{ __('messages.reset_password') }}</button>
                </form>
            </div>
        </div>
                ...
                <div class="features-list">
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-text">
                            <h3>{{ __('messages.gdpr') }}</h3>
                            <p>{{ __('messages.gdpr_description') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-text">
                            <h3>{{ __('messages.encryption_title') }}</h3>
                            <p>{{ __('messages.encryption_description') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-text">
                            <h3>{{ __('messages.data_locality') }}</h3>
                            <p>{{ __('messages.data_locality_description') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-text">
                            <h3>{{ __('messages.data_retention') }}</h3>
                            <p>{{ __('messages.data_retention_description') }}</p>
                        </div>
                    </div>
                </div>
            </div>
