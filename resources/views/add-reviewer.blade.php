                ...
                <div class="vertical-main-wizard">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="email" class="form-control form-control-lg mt-1" value="{{ old('email') }}">
                            @error('email')
                        ...
                        <div class="col-md-12 mt-4">
                            ...
                            <input type="password" name="password" class="form-control form-control-lg mt-1">
                            @error('password')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mt-4 text-end">
                            <button class="btn btn-primary" type="submit">{{ __('messages.add_reviewer') }}</button>
                        </div>
                    </div>
                </form>
                </div>
